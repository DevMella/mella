...
import nene12 from '../../assets/nene12.png';
import nene9 from '../../assets/nene9.png';
            ...
            <ul ref={slider}>
                <li>
                    <div className="image-container">
                        <h2 className='text-[45px] text-gray-500 font-bold mx-4'>THE SET</h2>
                        <img src={nene6} alt="Initial" className="image object-cover" />
                        <div>
                            <div className='flex justify-between px-6'>
                                <h1 className='font-bold text-[20px]'>THE BARRIER SET</h1>
                                <p className='font-bold text-[20px]'>#2800</p>
                            </div>
                            <h3 className='px-6 text-[18px] font-semibold'>Skin nourishing duo</h3>
                        </div>
                        <div className="hover-content">
                            <img src={cover} alt="Hover" className="image cover object-cover" />
                            <div className="sad">
                            <div class="voltage-button">
                                    <button>Buy barrier set - #28000</button>
                ...
                <li>
                    <div className="image-container">
                        <h2 className='text-[45px] text-gray-500 font-bold mx-4'>CLEANSE</h2>
                        <img src={nene10} alt="Initial" className="image object-cover" />
                        <div>
                            <div className='flex justify-between px-6'>
                                <h1 className='font-bold text-[20px]'>COCONUT REFRESH</h1>
                                <p className='font-bold text-[20px]'>#5400</p>
                            </div>
                            <h3 className='px-6 text-[18px] font-semibold'>The daily cleanser</h3>
                        </div>
                        <div className="hover-content">
                            <img src={cover1} alt="Hover" className="image object-cover cover" />
                            <div className="sad">
                            <div class="voltage-button">
                                    <button>Buy cleanser - #5400</button>
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 234.6 61.3" preserveAspectRatio="none" xml:space="preserve">
                ...
                <li>
                    <div className="image-container">
                        <h2 className='text-[45px] text-gray-500 font-bold mx-4'>TINT</h2>
                        <img src={nene12} alt="Initial" className="image object-cover" />
                        <div>
                            <div className='flex justify-between px-6'>
                                <h1 className='font-bold text-[20px]'>PEPTIDE LIP TINT</h1>
                                <p className='font-bold text-[20px]'>#2000</p>
                            </div>
                            <h3 className='px-6 text-[18px] font-semibold'>The tinted lip layer</h3>
                        </div>
                        <div className="hover-content">
                            <img src={cover4} alt="Hover" className="image object-cover cover" />
                            <div className="sad">
                            <div class="voltage-button">
                                    <button>Buy tint - #2000</button>
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 234.6 61.3" preserveAspectRatio="none" xml:space="preserve">
                ...
                <li>
                    <div className="image-container">
                        <h2 className='text-[45px] text-gray-500 font-bold mx-4'>THE KIT</h2>
                        <img src={nene9} alt="Initial" className="image object-cover" />
                        <div>
                            <div className='flex justify-between px-6'>
                                <h1 className='font-bold text-[20px]'>THE MELLA&trade; KIT</h1>
                                <p className='font-bold text-[20px]'>#45000</p>
                            </div>
                            <h3 className='px-6 text-[18px] font-semibold'>Six daily skin essentials</h3>
                        </div>
                        <div className="hover-content">
                            <img src={cover2} alt="Hover" className="image object-cover cover" />
                            <div className="sad">
                            <div class="voltage-button">
                                    <button>Buy the kit - #45000</button>
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 234.6 61.3" preserveAspectRatio="none" xml:space="preserve">
                ...
                <li>
                    <div className="image-container">
                        <h2 className='text-[45px] text-gray-500 font-bold mx-4'>PREP</h2>
                        <img src={nene4} alt="Initial" className="image object-cover" />
                        <div>
                            <div className='flex justify-between px-6'>
                                <h1 className='font-bold text-[20px]'>GLAZING MILK</h1>
                                <p className='font-bold text-[20px]'>#24000</p>
                            </div>
                            <h3 className='px-6 text-[18px] font-semibold'>The essential prep layer</h3>
                        </div>
                        <div className="hover-content">
                            <img src={cover1} alt="Hover" className="image object-cover cover" />
                            <div className="sad">
                                <div class="voltage-button">
                                    <button>Buy glazing milk - #24000</button>
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 234.6 61.3" preserveAspectRatio="none" xml:space="preserve">
